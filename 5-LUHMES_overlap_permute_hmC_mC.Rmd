...
Bvals_WT <- data.frame(GFP1.mC=Bvals_sub[,1], GFP2.mC=Bvals_sub[,2], GFP3.mC=Bvals_sub[,3], GFP4.mC=Bvals_sub[,4], GFP5.mC=Bvals_sub[,5], GFP6.mC=Bvals_sub[,6], GFP7.mC=Bvals_sub[,7], GFP1.hmC=Bvals_hmC_sub[,1], GFP2.hmC=Bvals_hmC_sub[,2], GFP3.hmC=Bvals_hmC_sub[,3], GFP4.hmC=Bvals_hmC_sub[,4], GFP5.hmC=Bvals_hmC_sub[,5], GFP6.hmC=Bvals_hmC_sub[,6], GFP7.hmC=Bvals_hmC_sub[,7], WT1.mC=Bvals_sub[,8], WT2.mC=Bvals_sub[,9], WT3.mC=Bvals_sub[,10], WT4.mC=Bvals_sub[,11], WT5.mC=Bvals_sub[,12], WT6.mC=Bvals_sub[,13], WT7.mC=Bvals_sub[,14], WT8.mC=Bvals_sub[,15], WT1.hmC=Bvals_hmC_sub[,8], WT2.hmC=Bvals_hmC_sub[,9], WT3.hmC=Bvals_hmC_sub[,10], WT4.hmC=Bvals_hmC_sub[,11], WT5.hmC=Bvals_hmC_sub[,12], WT6.hmC=Bvals_hmC_sub[,13], WT7.hmC=Bvals_hmC_sub[,14], WT8.hmC=Bvals_hmC_sub[,15], A30P1.mC=Bvals_sub[,16], A30P2.mC=Bvals_sub[,17], A30P3.mC=Bvals_sub[,18], A30P4.mC=Bvals_sub[,19], A30P5.mC=Bvals_sub[,20], A30P6.mC=Bvals_sub[,21], A30P7.mC=Bvals_sub[,22], A30P8.mC=Bvals_sub[,23], A30P1.hmC=Bvals_hmC_sub[,16], A30P2.hmC=Bvals_hmC_sub[,17], A30P3.hmC=Bvals_hmC_sub[,18], A30P4.hmC=Bvals_hmC_sub[,19], A30P5.hmC=Bvals_hmC_sub[,20], A30P6.hmC=Bvals_hmC_sub[,21], A30P7.hmC=Bvals_hmC_sub[,22], A30P8.hmC=Bvals_hmC_sub[,23])

colCol <- as.matrix(c(rep("black",7), rep("gray40",7), rep("gray75", 8), rep("gray90", 8), rep("gray48", 8), rep("gray65", 8)))
genotypeLab <- c(rep("Control",14), rep("SNCA-OE", 16), rep("A30P", 16))

heatmap.plus_oneColSide(as.matrix(Bvals_WT), ColSideColors = colCol, ,labCol=genotypeLab, Colv = NA, Rowv=NA, col=Bu, margins=c(9,22), cexRow=0.5)
legend.gradient(pnts=cbind(x =c(0.83,0.88,0.88,0.83), y =c(0.3,0.3,0.2,0.2)),cols=Bu, cex=0.7, title="Beta value", limits=c(round(min(Bvals_WT),2), round(max(Bvals_WT),2)))
```
...
#colour rows (probes) by direction of change in WT vs A30P
#WT_A30P_hmC_gene_list <- read.csv("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/DHMPs_WT_A30P_all.csv")
...
Bvals_A30P <- data.frame(GFP1.mC=Bvals_sub[,1], GFP2.mC=Bvals_sub[,2], GFP3.mC=Bvals_sub[,3], GFP4.mC=Bvals_sub[,4], GFP5.mC=Bvals_sub[,5], GFP6.mC=Bvals_sub[,6], GFP7.mC=Bvals_sub[,7], GFP1.hmC=Bvals_hmC_sub[,1], GFP2.hmC=Bvals_hmC_sub[,2], GFP3.hmC=Bvals_hmC_sub[,3], GFP4.hmC=Bvals_hmC_sub[,4], GFP5.hmC=Bvals_hmC_sub[,5], GFP6.hmC=Bvals_hmC_sub[,6], GFP7.hmC=Bvals_hmC_sub[,7], WT1.mC=Bvals_sub[,8], WT2.mC=Bvals_sub[,9], WT3.mC=Bvals_sub[,10], WT4.mC=Bvals_sub[,11], WT5.mC=Bvals_sub[,12], WT6.mC=Bvals_sub[,13], WT7.mC=Bvals_sub[,14], WT8.mC=Bvals_sub[,15], WT1.hmC=Bvals_hmC_sub[,8], WT2.hmC=Bvals_hmC_sub[,9], WT3.hmC=Bvals_hmC_sub[,10], WT4.hmC=Bvals_hmC_sub[,11], WT5.hmC=Bvals_hmC_sub[,12], WT6.hmC=Bvals_hmC_sub[,13], WT7.hmC=Bvals_hmC_sub[,14], WT8.hmC=Bvals_hmC_sub[,15], A30P1.mC=Bvals_sub[,16], A30P2.mC=Bvals_sub[,17], A30P3.mC=Bvals_sub[,18], A30P4.mC=Bvals_sub[,19], A30P5.mC=Bvals_sub[,20], A30P6.mC=Bvals_sub[,21], A30P7.mC=Bvals_sub[,22], A30P8.mC=Bvals_sub[,23], A30P1.hmC=Bvals_hmC_sub[,16], A30P2.hmC=Bvals_hmC_sub[,17], A30P3.hmC=Bvals_hmC_sub[,18], A30P4.hmC=Bvals_hmC_sub[,19], A30P5.hmC=Bvals_hmC_sub[,20], A30P6.hmC=Bvals_hmC_sub[,21], A30P7.hmC=Bvals_hmC_sub[,22], A30P8.hmC=Bvals_hmC_sub[,23])

colCol <- as.matrix(c(rep("black",7), rep("gray40",7), rep("gray75", 8), rep("gray90", 8), rep("gray48", 8), rep("gray65", 8)))
genotypeLab <- c(rep("Control",14), rep("SNCA-OE", 16), rep("A30P", 16))

heatmap.plus_oneColSide(as.matrix(Bvals_A30P), ColSideColors = colCol, ,labCol=genotypeLab, Colv = NA, Rowv=NA, col=Bu, margins=c(9,22), cexRow=0.5)
legend.gradient(pnts=cbind(x =c(0.83,0.88,0.88,0.83), y =c(0.3,0.3,0.2,0.2)),cols=Bu, cex=0.7, title="Beta value", limits=c(round(min(Bvals_A30P),2), round(max(Bvals_A30P),2)))
```
