...
UPDATE JAN 24: Changed PCA plot code for Nicole's updated one (includes multiple test correction and heatmaps with continuous variables).
...
#oxBS
type <- fData(LUHMES.2_filtered)$INFINIUM_DESIGN_TYPE
...
![Beta value distribution by probe type, oxBS samples](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/betas_by_probe_type_oxBS_06182020.png)

![Beta value distribution by probe type, BS samples](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/betas_by_probe_type_BS_06182020.png)
