...
Gene_CpG_Relations_update <- Gene_CpG_Relations_update[Gene_CpG_Relations_update$Probe_ID %in% WT_gene_list$Name,]

annEPIC <- read.csv("~/KoborLab/kobor_space/shared_coding_resource/Illumina_EPIC/EPIC_KH_Annotation.csv", row.names = 1)
annEPIC <- annEPIC[annEPIC$Name %in% WT_gene_list$Name,]
...
#[1] "Enrichment: 0.666; Depletion 1; Feature: "
#[1] "Enrichment: 1; Depletion 1; Feature: 3'UTR"
#[1] "Enrichment: 1; Depletion 1; Feature: 5'UTR"
#[1] "Enrichment: 0.018; Depletion 1; Feature: Body"
#[1] "Enrichment: 1; Depletion 0.081; Feature: Enhancer"
...
#[1] "Enrichment: 1; Depletion 0; Feature: 1stExon"
...
#   48829      918     4488    14498    71925    73307     1377    14023     4075 
...
locations <- Gene_CpG_Relations_update[Gene_CpG_Relations_update$Probe_ID %in% WT_gene_list[WT_gene_list$threshold==TRUE,"Name"],"region"]
loc_summary <- summary(as.factor(locations))
loc_summary
#            3'UTR    5'UTR     Body Enhancer  ExonBnd  TSS1500   TSS200 
#      54        5       15       86       38        1        9        7 
loc_summary <- c(loc_summary, `1stExon`=0.1)
loc_summary <- loc_summary[c(1,9,2:8)]
...
locations <- Gene_CpG_Relations_update[Gene_CpG_Relations_update$Probe_ID %in% A30P_gene_list[A30P_gene_list$threshold==TRUE,"Name"],"region"]
loc_summary <- summary(as.factor(locations))
loc_summary
#            3'UTR    5'UTR     Body Enhancer  TSS1500   TSS200 
#      17        2        6       21       19        2        2 
loc_summary <- c(loc_summary, `1stExon`=0.1, ExonBnd=0.1)
loc_summary <- loc_summary[c(1,8,2:5,9,6:7)]
...
locations_norm$sig <- as.factor(c("","***",rep("",2),"*",rep("",5),"***",rep("",7)))

summary(locations_norm$fold_change)
#    Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
#-8.45878 -1.69210  0.05377 -0.64211  1.27550  1.86425 
