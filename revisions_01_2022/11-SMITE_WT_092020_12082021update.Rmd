...
save(LUHMES_annotation_rescaled, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_annotation_rescaled_WT_122021.RData") #saved 12/2021 when re-running old code, in order to easily come back from this point and try different modification weights
```
...
save(LUHMES_scored_equal, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_equal.RData")
...
save(LUHMES_scored_mC, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_mC.RData")
...
save(LUHMES_scored_hmC, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_hmC.RData")
...
save(LUHMES_scored_mC_exp, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_mC_exp.RData")
```
...
library(SMITE)
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_equal.RData")
...
save(LUHMES_spinglass_equal, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_equal.RData")
###########################

#######To run in Terminal - 2
library(SMITE)
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_mC.RData")
...
save(LUHMES_spinglass_mC, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_mC.RData")
###########################

#######To run in Terminal - 3
library(SMITE)
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_hmC.RData")
...
save(LUHMES_spinglass_hmC, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_hmC.RData")
###########################

#######To run in Terminal - 4
library(SMITE)
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_scored_mC_exp.RData")
...
save(LUHMES_spinglass_mC_exp, file="~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_mC_exp.RData")
###########################
```
...
### Equal weighted
```{r}
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_equal.RData")
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_mC.RData")
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_hmC.RData")
load("~/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/LUHMES_spinglass_mC_exp.RData")
...
ggplot(pval_df_melt, aes(x=value, fill=value)) + geom_bar(stat="count", show.legend=FALSE, col="black") + facet_wrap(~variable) + theme_classic() + ylab("Number of Genes") + xlab("P-value") + scale_fill_manual(values=c("blue","grey")) + geom_text(stat="count", aes(label = after_stat(count)), vjust=-0.5, size=3.5) + ylim(c(0,170)) + ggtitle("Significant WT aSyn Module Genes")
```
![Summary of significant SMITE module genes, mC-weighted model](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/SMITE_WT_mC.png)
...
#DNAm prom: 6 genes
#DNAm body: 44 genes
#DNAm enhancer: 11 genes
#DNAhm promoter: 0 genes
#DNAhm body: 2 genes
#DNAhm enhancer: 2 genes
#Expression: 105 genes

sig_genes <- unique(unlist(apply(pval_df_summary[,9:15], 2, function(x) grep("<=0.05",x))))
nrow(pval_df_summary_sig <- pval_df_summary[sig_genes,]) #148

pval_df_melt <- melt(pval_df_summary_sig[,8:15], id.vars="gene")
ggplot(pval_df_melt, aes(x=value, fill=value)) + geom_bar(stat="count", show.legend=FALSE, col="black") + facet_wrap(~variable) + theme_classic() + ylab("Number of Genes") + xlab("P-value") + scale_fill_manual(values=c("blue","grey")) + geom_text(stat="count", aes(label = after_stat(count)), vjust=-0.5, size=3.5) + ylim(c(0,170)) + ggtitle("Significant WT aSyn Module Genes")
```
![Summary of significant SMITE module genes, hmC-weighted model](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/SMITE_WT_hmC.png)
...
sig_genes <- unique(unlist(apply(pval_df_summary[,9:15], 2, function(x) grep("<=0.05",x))))
nrow(pval_df_summary_sig <- pval_df_summary[sig_genes,]) #142

pval_df_melt <- melt(pval_df_summary_sig[,8:15], id.vars="gene")
ggplot(pval_df_melt, aes(x=value, fill=value)) + geom_bar(stat="count", show.legend=FALSE, col="black") + facet_wrap(~variable) + theme_classic() + ylab("Number of Genes") + xlab("P-value") + scale_fill_manual(values=c("blue","grey")) + geom_text(stat="count", aes(label = after_stat(count)), vjust=-0.5, size=3.5) + ylim(c(0,170)) + ggtitle("Significant WT aSyn Module Genes")
```
![Summary of significant SMITE module genes, mC_exp-weighted model](/home/BCRICWH.LAN/sschaffner/KoborLab/kobor_space/sschaffner/LUHMES_201806/clean_scripts/SMITE_WT_mC_exp.png)
